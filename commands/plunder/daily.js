module.exports = {
    ...
    "run":async (imports) => {
        ...
        imports.db.updateDoc('users', imports.message.author.id, {$inc: {cp: 25}, $set: {dailyClaim: Date.now()}});
        return imports.message.channel.send("You have claimed your daily dose of 25 COD points. Come back another day.");
    }
}