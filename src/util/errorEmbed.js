...
module.exports = function errorEmbed(error){
    ...
    .setFooter(getFooter("Please make sure noone have ever posted a similar issue and please provide reproduction steps."), global.client.user.displayAvatarURL({dynamic: true, format: "png"}))
    .setTimestamp()
